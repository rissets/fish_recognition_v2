    ...
    def _load_models(self):
        ...
        try:
            ...
            self.classifier = EmbeddingClassifier(
                model_path=model_settings['CLASSIFICATION_MODEL'],
                data_set_path=model_settings['CLASSIFICATION_DATABASE'],
                device=self.device,
                labels_file=model_settings.get('CLASSIFICATION_LABELS')
            )
        ...
        try:
            ...
            for result in classification_result:
                formatted_results.append({
                    ...
                    "species_id": result.get('species_id', -1),
